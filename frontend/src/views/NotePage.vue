<template>
  <div class="flex flex-col h-screen bg-gray-50">
    ...
    <div class="flex flex-wrap items-center bg-white px-4 py-3 shadow-md flex-shrink-0">
      <!-- Back button -->
      <button @click="goBack" class="text-gray-600 hover:text-gray-800 font-semibold mr-2 flex-shrink-0">
    ...
    <div class="flex-1 p-4">
      <textarea v-model="note.content" placeholder="Start typing your note... Remember to click save..."
        class="w-full h-full text-lg leading-relaxed bg-transparent border-none focus:outline-none focus:ring-0 resize-none"></textarea>
    </div>
  </div>
</template>
